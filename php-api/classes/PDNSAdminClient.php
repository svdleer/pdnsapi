 ...
 * 
 * For advanced features not in PowerDNS Admin API (like templates),
 * use local database models as supplements.
 */
class PDNSAdminClient {
    ...
    // ❌ Individual zone retrieval/updates not supported (HTTP 405)
